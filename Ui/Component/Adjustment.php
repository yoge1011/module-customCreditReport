...
class Adjustment extends \Magento\Backend\Block\Widget\Grid\Column
{
    /**
    ...
    */
    ...
    public function getRowField(\Magento\Framework\DataObject $row)
    {
        ...
        $adjustment = $row->getData('adjustments');

        return $this->_helperCore->currency(sprintf('%0.2f', $adjustment));
